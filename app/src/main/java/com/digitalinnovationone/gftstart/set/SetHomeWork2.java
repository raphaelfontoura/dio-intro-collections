...
public class SetHomeWork2 {
    ...
    private static class LanguageProgramming implements Comparable<LanguageProgramming> {
    ...
    private static class CompareLanguageByYearAndName implements Comparator<LanguageProgramming> {
    ...
    private static class CompareLanguageByNameYearIDE implements Comparator<LanguageProgramming> {
